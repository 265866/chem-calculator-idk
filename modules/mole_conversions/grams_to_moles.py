...
def grams_to_moles():
    ...
    print_dict = {}
    print_dict[1] = [f'{str(print_dict_grams)}g {compound}', f'1 mol {compound}']
    ...
    print(f'Remember to adjust for sigfigs, your input was {inp}g of {compound}')
